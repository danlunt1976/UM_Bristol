...
- clouds. the so-called "indirect effect" or ACI: Aerosol-cloud interaction. This is where aerosols affect clouds and increase both their lifetime and albedo.
...
(so the indirect effect can be switched on/off indiivdiually for SW/LW radiative effects)

NOTE - CURRENTLY (FEB 2026) THE INDIRECT EFFECT DOES NOT WORK - CHRIS TO WRITE UP NOTES, BUT IT SYSTEMATICALLY CAUSES NEGATIVE THETA/PRESSURE CRASHES EVERY YEAR OR TWO DESPITE COMPILING OK.
