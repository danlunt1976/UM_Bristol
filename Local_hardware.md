...
| triassic                 | Rocky 8     | array-01 74 TB                                               | UM downloads                                                                                         | Currently acting as webserver proxy for oligocene external traffic (was miocene).                                                                                                   | Geog server room     |
...
| miocene                  | Rocky 8     | ~22TB                                                        | will be UM downloads (was CMIP6 data, which is now on BP)                                            | To be tested.                                                                                                                                                                       | Geog server room     |
...
| paleocene                | Rocky 8     | holocene-01 327 TB archived to ACRC tape library             | will be new web server and ummodel/data.                                                             | will replace oligocene.                                                                                                                                                             | Computer Centre (CC) |
| happi                    | Rocky 8     | 28 TB                                                        | Climate Dynamics group.                                                                              | Not currently widely used.                                                                                                                                                          | Computer Centre (CC) |
