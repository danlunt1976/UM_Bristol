...
| $MODS/clim/vn4.4/hadam3/AMIPII/rssafehs4.4        | y                                     | Seems to fix a problem with dumps if using real calendar and daily dumps. Also adds printout for reasons for date problems                                    | Don’t think so. It just bug fixes dump reading/writing                        | PUM                                                                                                                                       |
...
- Add a mod for the sulphur cycle:
  
   `~tw23150/mods/Sulphur/gbccf406_co2`
...
- Some removed mods:
  ...
  - $PV_UPDATES/hard_wired_tdvqh
    - This produces high latitude warming, basically needed by paleo simulations. But should also be compiled for future warming scenarios. The params might be used in the local processing script. In doubt.
  
  - $PV_UPDATES/optimise_occ_10
    - This tunes remineralisation rates for the surface layers and deep layers. As this leads to overall alkanility losing, not using.
...
- Mods we need:
  ...
  - ~tw23150/mods/gath_fld_co2.mf77
    - Definitely needed.
  
  - ~tw23150/mods/acn1f406
    - Definitely needed.
  ...
  - ~tw23150/mods/mod1702_cdj_2024.mf77
    - Needed.
  
  - ~tw23150/mods/carb_no_rad_presc.mf77
    - Only needed when climate change is not needed for TRIFFID.
  
  - ~tw23150/mods/carb_no_veg_presc.mf77
    - Only needed when co2 change is not needed for TRIFFID.
  
  - ~tw23150/Mods/T3E/is92a_co2_vn4.5.mod
...
- Mods good to keep:
  ...
  - $MODS_SULPC/bl_7a_fix.mod
  - $MODS_SULPC/SUL_dens_fix.mf77
  - $MODS_SULPC/SO4_indirect
...
- ~ggpjv/scripts/land_cc
  - Replace with Seb's: ~nd20983/scripts/land_cc_v2
- ~ggpjv/scripts/make_tdvqh
  - For high latitude warming
- ~ggpjv/scripts/ocean_tEwzR
...
- ~swsvalde/scripts/add_volcanic_file
  - Add vol file.
- ~swsvalde/scripts/salinity_update
  - Update modern salinity.
- ~swsvalde/scripts/solar_orbit_update
  - Update solar params.

Might also need:

- ~nd20983/scripts/emi_recon
  - Needed for emission-driven runs.
- ~nd20983/scripts/ghgs_co2_deglac_ver03_last2k
