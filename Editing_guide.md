...
In order to contribute, you will need an account on github. Apply here for a (currently!) free account:  [https://github.com/signup](https://github.com/signup) .  Once you have an account on github (see above), email Dan Lunt <d.j.lunt@bristol.ac.uk> with your github username, and he will invite you to be a collaborator.  You will then have edit-rights. 
...
[https://github.com/danlunt1976/UM_Bristol](https://github.com/danlunt1976/UM_Bristol)
...
(1) Download the 'GitHub Desktop' app for Windows: [https://desktop.github.com/download/](https://desktop.github.com/download/)

(2) Clone a copy of the repository, following these instructions: [https://docs.github.com/en/desktop/adding-and-cloning-repositories/cloning-a-repository-from-github-to-github-desktop](https://docs.github.com/en/desktop/adding-and-cloning-repositories/cloning-a-repository-from-github-to-github-desktop) .  You can choose anywhere on your local filesystem to hold your local copy.

(3) You can edit the .md files in your local copy using whatever editing sofware you wish (e.g. Wordpad).  However, to have access to some useful tools, you can use a specific markdown file editor.  One example is Obsidian.  Download it to your desktop here:  [https://obsidian.md/download](https://obsidian.md/download) .   Open Obsidian and click on 'Open folder as vault'.  It should then be fairly intuitive how to edit files.
